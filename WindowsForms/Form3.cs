...
{//program.cs de : ()içinde hangi form yazılı olursa başlangıçta onu çalıştırır , windows form projesi çalıştırıldığında hangi formun açılacağını buradan ayarlıyoruz.
 //timer: zamanlayıcı, belli süreyle işlemler yaptırırız
