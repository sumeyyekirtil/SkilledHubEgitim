namespace SOLIDPrensipleri
{
	internal class Program
	{
		...
		{//Anayasaya benzetilebilir
			...
			Console.WriteLine("Robert Celil Martin tarafından öne sürülen geliştirilecek yazılımın esnek yeniden kullanılabilir sürdürülebilir ve anlaşılır olmasını hedefleyen, kod tekrarını önleyen prensipler bütünüdür");
			Console.WriteLine("");
			...
			Console.WriteLine(" \t Sorumlulukların hepsini tek bir arayüzde toplamak yerine özelleştirilmiş birden fazla arayüz kullanmalıyız"); //1 Arayüz de bütün özellikler toplanmamalı, birden fazla class ı aynı yerden idare etmemeliyiz
